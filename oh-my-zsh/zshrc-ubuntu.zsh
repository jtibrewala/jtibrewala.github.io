...
# export ZSH=/home/jaideep/.oh-my-zsh
...
# ZSH_THEME_RANDOM_CANDIDATES=( "robbyrussell" "agnoster" "superjarin")
...
# For zsh-completion of command
autoload -U compinit && compinit

# For tilix vte.sh fix
...
# for pulseeffects to work properly
